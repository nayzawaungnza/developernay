...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Developer:Nay" />
    <meta name="author" content="" />
    <meta name="keywords" content="Developer:Nay" />
    ...
    @yield('ckeditor')
    <!-- Owl Carousel  -->
    <link rel="stylesheet" href="{{ asset('admin/dist/libs/owl.carousel/dist/assets/owl.carousel.min.c') }}ss">
    
    <!-- Core Css -->
    <link  id="themeColors"  rel="stylesheet" href="{{ asset('admin/dist/css/style.min.css') }}" />
    <link  id="themeColors"  rel="stylesheet" href="{{ asset('admin/dist/css/style.css') }}" />
        ...
        <div>
          <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="{{ route('customer#index') }}" target="_blank" class="text-nowrap logo-img">
              <img src="{{ asset('admin/dist/images/logos/DeveloperNay.png') }}" class="dark-logo" width="113" alt="" />
              <img src="{{ asset('admin/dist/images/logos/DeveloperNayWhite.png') }}" class="light-logo"  width="180" alt="" />
            </a>
            ...
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link has-arrow" href="#" aria-expanded="false">
                  ...
                  <span class="hide-menu">Profile Data</span>
                </a>
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="{{ route('admin#profiledata') }}" class="sidebar-link">
                  ...
                  <li class="sidebar-item">
                    <a href="{{ route('admin#profile#create') }}" class="sidebar-link">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <li class="sidebar-item">
                    <a href="{{ route('admin#portfolio#create') }}" class="sidebar-link">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">Add New</span>
                          ...
                          <div class="row">
                            <div class="col-6">
                              <div class="position-relative">
                                <a href="#" class="d-flex align-items-center pb-9 position-relative text-decoration-none text-decoration-none text-decoration-none text-decoration-none">
          ...
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">@yield('bread-title')</h4>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar" aria-labelledby="offcanvasWithBothOptionsLabel">
      <nav class="sidebar-nav scroll-sidebar">
        <div class="offcanvas-header justify-content-between">
          <img src="{{ asset('admin/dist/images/logos/favicon.ico') }}" alt="" class="img-fluid">
